...
const ChatRoom = () => {
  ...
  const onMessage = useCallback(
    (data) => {
      ...
      // clear message notifications when actively in chat
    ...
    <div className="flex flex-col h-screen bg-[#F1F4F9] font-sans">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-bold text-gray-900 leading-none">
                {messages.find((m) => m.sender_id !== currentUserId)
                  ?.sender_name || "Chat"}
              </h2>
      ...
      <div className="flex-1 overflow-y-auto pt-24 pb-32 px-6 flex flex-col gap-4">
        ...
        {messages.map((msg, index) => {
          const isMine =
            msg.sender === currentUserId || msg.sender_id === currentUserId;
          return (
            <div
              key={index}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      className={`text-[9px] font-bold uppercase opacity-50 ${isMine ? "text-indigo-200" : "text-gray-400"}`}
                    >
